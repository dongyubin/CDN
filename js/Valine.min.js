...
*/
        ...
        var o = n(9).version, a = n(6), s = n(8), l = n(0), c = n(5), d = n(3), u = n(4), p = n(2), f = n(7),
            h = {comment: "", nick: "Anonymous", mail: "", link: "", ua: navigator.userAgent, url: ""}, v = {
                "zh-cn": {
                ...
                params: "",
                hide: !1
            }, m = ["nick", "mail", "link"], b = Storage && localStorage && localStorage instanceof Storage && localStorage,
            x = location.pathname.replace(/index\.html?$/, "");
        r.prototype.init = function (e) {
            if ("undefined" == typeof document) return void console;
            var t = this;
            try {
                var n = e.lang || "", r = e.langMode || "", i = g.ds, a = e.avatar, l = e.avatarForce,
                    c = e.avatar_cdn || "";
                ...
                var h = e.app_id || e.appId, b = e.app_key || e.appKey, y = (e.region || "cn").toLowerCase(),
                    k = ["cn", "us"];
                ...
                var M = u.create("div", "class", "vloading"), L = u.find(t.el, ".vlist");
                t.loading = {
                    show: function (e) {
        ...
        r.prototype.Q = function (e) {
            ...
            var t = this, n = u.find(t.el, ".vemojis"), r = u.find(t.el, ".vpreview"), i = u.find(t.el, ".vemoji-btn"),
                o = u.find(t.el, ".vpreview-btn"), f = p.data;
            ...
            }, I = u.find(t.el, ".vsubmit"), P = function (e) {
        ...
        e.exports = {
            ...
            copyright: "©️",
            registered: "®️",
			tandupi: "https://bestzuo.cn/emoji/弹肚皮.gif"
        }
    }, function (e, t, n) {
        var r = n(13);
